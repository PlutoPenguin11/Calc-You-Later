...
public class Calculator extends JFrame {
    ...
    private void actionListenerInit() {
        ...
        prevButton.addActionListener(e -> inputField.setText(inputField.getText() + "prevButtonHit"));
    ...
    private void $$$setupUI$$$() {
        ...
        calculatorPanel.add(spacer1,
                new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1,
                        GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(344, 14), null, 0, false));
        ...
        calculatorPanel.add(spacer2,
                new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_VERTICAL, 1,
                        GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(344, 19), null, 0, false));
